  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: cn(
          "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-muted [&:has([aria-selected].day-outside)]:bg-muted/50 [&:has([aria-selected].day-range-end)]:rounded-r-lg",
          props.mode === "range"
      ...
      components={{
        ...
        IconRight: ({ ...props }) => <ChevronRight className="size-5" />,
      }}
      {...rest}
    />
  );
